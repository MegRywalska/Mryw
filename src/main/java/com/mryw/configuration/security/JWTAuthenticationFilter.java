package com.mryw.configuration.security;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.mryw.dto.AuthorizationDto;
...
//<!--        Autoryzacja - kiedy chcemy się zalogować    -->
@Slf4j
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest req, HttpServletResponse res,
        ...
        String username = ((UserMryw) auth.getPrincipal()).getUsername();

//        this.appUserService.setLastSeen(System.currentTimeMillis(), username);
        StringBuilder stringBuilder = new StringBuilder("ROLE_USER");
